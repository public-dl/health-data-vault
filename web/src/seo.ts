export const pages={
 '/':{title:'Health Data Vault｜新潟県の特定健診データを市町村別に可視化',description:'新潟県30市町村の特定健康診査データを、市町村別・年度別に地図、表、グラフで可視化。公表された報告人数と総合判定の構成比を、対象年度・定義・出典とともに確認できます。年度間の比較可能性など、データを読む際の制約も示しています。'},
