...
import {format,formatValue,isCountPublication,type Observation} from './model';
export function temporalTable(records:Observation[],selectedYear:number,measure:'count'|'rate') {
 ...
 const metrics=isCountPublication(visible)?[
